...
def test_speech_graph() -> None:
    ...
    from variables_test import expected_node_list1, expected_edges1, expected_degree1
    ...
    from variables_test import expected_node_list2, expected_edges2, expected_degree2
