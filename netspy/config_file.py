...
class PreProcessing(BaseModel):
    ...
    problematic_symbols: Dict[str, str]
    interjections: List[str]
...
class Config(BaseModel):
    ...
    server: Servers = Servers(openie=ServerInfo(port = 5000), corenlp=ServerInfo(port = 5500))

    preprocess: PreProcessing = PreProcessing(problematic_symbols = {
        "’": "'",
        "“": "",
        "”": "",
        # '..': " ",
